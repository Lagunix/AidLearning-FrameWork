...
<p align="center"><a href="https://www.bilibili.com/video/BV1p3411x7iX" target="_blank">Официальный релиз AidLux 1.3 ！(Смотрите видео⬆️📺)</a></p>
<p align="center">
  AI，Android，Linux，ARM：基于Android+Linux - платформа для разработки приложений с искусственным интеллектом и экосистемой.  <a href='README-en.md'>[English]</a>
</p>
<p align="center">
